...
class Instagraph
{
    ...
    public $_image = NULL;
    public $_output = NULL;
    public $_prefix = DIR_IMAGE_UPLOADS;
    private $_width = NULL;
    ...
    public function earlybird()
    {
        ...
        $command = "convert $this->_tmp -modulate 120,80,100 -fill #AA3300 -colorize 20 $this->_tmp";
    ...
    public function black_white()
    {
        ...
        $command = "convert $this->_tmp -type Grayscale $this->_tmp";
