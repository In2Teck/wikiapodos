...
class _image {
	...
	public $errors = array(
		'no-image' 		=> 'Error: Please specify a source image - declare: $mj_Image->source_file = "path_to_your_image_here.jpg";',
		'no-width' 		=> 'Error: Please specify a width for the new image - declare: $mj_Image->newWidth = 100;',
		'no-height' 	=> 'Error: Please specify a height for the new image - declare: $mj_Image->newheight = 100;',
		'image-exists' 	=> 'Error: The image you specified already exists',
		'upl-no-array'	=> 'Error: It appears the form did not submit a valid file - please try again.',
		'upl-ini-max'	=> 'Error: The file uploaded exceeds the filesize limit set on this server',
		'upl-maxsize'	=> 'Error: The file uploaded exceeds the filesize limit set for this form',
		'upl-partial'	=> 'Error: The file was only partially uploaded - please try again',
		'upl-no-file'	=> 'Error: No file was submitted for upload',
		'upl-no-tmpDir'	=> 'Error: The temporary upload directory is missing',
		'upl-cant-write'=> 'Error: Failed to write to the temporary folder - please check the permissions',
		'upl-ext'		=> 'Error: The upload was stopped due to an invalid file extension',
		'upl-no-size'	=> 'Error: The file submitted for upload had a filesize of zero or was corrupt',
		'upl-failed'	=> 'Error: The upload failed - the file could not be moved to the target location - please check the permissions',
		'no-crop-width' => 'Error: Please specify a crop width for the new image',
		'no-crop-height'=> 'Error: Please specify a crop height for the new image',
		'no-crop-x' 	=> 'Error: Please specify a crop x position for the new image',
		'no-crop-y'		=> 'Error: Please specify a crop y position for the new image',
		'crop-ext'		=> 'Error: The crop was stopped due to an invalid file extension',
	);
	...
	public function upload($ar) {
		...
		if ($ext != 'jpg' && $ext != 'jpeg' && $ext != 'png') {
			$this->doDie($this->errors['upl-ext']);
			exit;
		}
	...
	public function doDie($msg,$file="",$line="") { 					// doDie - calls a die function with custom error
		...
		if (($file!='') && ($line!='')) {
			$log->write($msg.' (File: '.$file.' on line: '.$line.')');
		} else {
			$log->write($msg);
		}
	}
